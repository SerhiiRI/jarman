...
** application context
   ...
   - session
   - gui parts
** TODO /Refactor/. =.jarman= loading
  Fix loading stage, =.jarman= should be loaded after plugin was compiled.
** TODO /Refactor/. jarman.tools cleaning                              :@Julia:
  - [ ] =jarman.tools=, should be replaced on =jarman.lib= with subfolders
  - [ ] =jarman.tools.lang= [0/2]
    - [ ] clean and archive unnecessary function
    - [ ] push onto top-level
  - [ ] =jarman.tools.org=. Push onto top-level
  - [ ] =jarman.tools.swing=.
    This namespace should be divided. New place for any swing
    toolkit's is =jarman.gui.swing=. 
    - [ ] move =jarman.gui.components.swing= to =jarman.gui.swing=.
    - [ ] push some swing toolkit to this namespace.
    - [ ] rename this namespace to something like /resource-connector/.
