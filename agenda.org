...
** TODO /Bug/. Service Plugin                                          :@Aleks:
   replace /gtool/ on /external.clj/ 
** TODO [#1] /Rewrite/. DB Visualizer editing [2/3]            :@Aleks:@Serhii:
   DEADLINE: <2021-10-13 Wed>
   Old fns must be rewrite to new standards:
   1. [X] Cannot edit table view
   3. [X] Cannot edit metadata of table 
...
** DONE Register licence mechanics                                  :@Serhii:
   CLOSED: [2021-11-07 Sun 16:49]
