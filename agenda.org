...
** PROCESSING [#1] /Feature/. Rewrite plugin system                   :@Serhii:
   ...
   - [ ] Add ~:deps~ key into ~package~
     - [ ] create package compiling sequence 
   - [X] View plugin
...
** PLANNED [#3] /Feature/. Support Org file                           :@Serhii:
   - [ ] Create library for printing directly to org file
...
* Infrastructure
* Documentations
** PROCESSING [#3] Create jarman Vocabluary                         :@Serhii:
