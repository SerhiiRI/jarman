...
*** TODO Upgrade UI Elements                                         :@Aleks:
    :PROPERTIES:
...
** TOREVIEW [#2] Bug. Use system font's for linux                   :@Serhii:
...
** PLANNED Table Controller Forms
** PLANNED Config Generator Upgrade and Fix
...
** PLANNED Base components and views                         :@Aleks:@Serhii:
...
** PLANNED Clobal event on key pressed                        :@Julia:@Aleks:
...
** PLANNED DB Visualiser, finishing                   :@Julia:@Aleks:@Serhii:
...
** PLANNED DB Visualiser: Table adding form                          :@Julia:
** PLANNED /Feature/. Update Manager
...
** PLANNED /Feature/. Extension Manager
   - [ ] Related to [[#alert-boxes-replacement]], fix alert boxes.
...
** PLANNED [#3] Versioning data structure
