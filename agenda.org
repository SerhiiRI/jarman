...
** TODO [#2] /Feature/. Create configurations panel                   :@Serhii:
   - [ ] Language select box
...
* Backend
** PROCESSING [#1] Permission system                                 :@Julia:
   ...
   - [X] Add into /left-bar menu/, /left-menu/ functionlity that test user permission before
     render
   - [ ] View plugins permission system 

** TODO [#1] Move dialog plugins into the /table.clj/                  :@Julia:
** TODO [#1] Одужуй!                                                 :@Julia:
