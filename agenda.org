...
** PROCESSING [#1] /Feature/. Interaction files [2/3]                :@Aleks:
   :PROPERTIES:
...
** PROCESSING [#1] Frontend refactorization [2/8]
*** TODO Alerts upgrade [1/3]                                        :@Aleks:
...
*** TOREVIEW Cooperative theme standarization [0/1]
      - [ ] Main menu [0/2]
