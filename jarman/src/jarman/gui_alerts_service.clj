...
(defn message
  ...
  (fn [data]
    (let [font-c "#000"
          ...
          close [(build-bottom-ico-btn icon/x-blue-64-png icon/loupe-blue1-64-png layered 23 (fn [e] (view-selected-message header body layered)))
                 (build-bottom-ico-btn icon/x-blue-64-png icon/x-blue1-64-png layered 23 (fn [e] (let [to-del (.getParent (.getParent (seesaw.core/to-widget e)))] (alerts-controller :rm-obj to-del))))]]
      (mig-panel
       :id :alert-box
                                   ...
                                   [(mig-panel
                                     ...
                                     :items [[(label-fn
                                             ...
                                             [(label-fn
                                               ...
                                               :icon (image-scale icon/basket-blue1-128-png ico-size)
                                               :halign :center
                                               :font (getFont 14)
                                               :size [(/ w 2) :by ico-size]
                                               :background btn-bg-c
