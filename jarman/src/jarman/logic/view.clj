...
(defview
 ...
 (table
  ...
  (dialog-table
   :id :select-name-permission
   :tables [:permission]
   :view-columns [:permission.permission_name :permission.configuration]
   :query {:table_name :permission
           :column [:#as_is :permission.permission_name :permission.configuration :permission.id]}
   :name
   "Dialog"
   :permission
   [:user])
  (dialog-test
   ...
   [:user])
  (dialog-bigstring
   :id :select-name-bigstring
   :query {:table_name :permission
           :column [:#as_is :permission.permission_name :permission.id]}
   :item-column :permission.permission_name
   :name
   "Dialog box"
   :permission
   [:user]))
